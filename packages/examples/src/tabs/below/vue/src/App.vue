  ...
  <plus-tabs value="1">
    <plus-tabs-panels>
      ...
      <plus-tabs-panel value="2">
        ...
        Maecenas cursus nec ipsum et tempus. Sed pretium odio bibendum, pharetra
        nisl sed, scelerisque ipsum. Nam egestas interdum risus et gravida.
        Suspendisse aliquam leo ac leo fermentum, ac accumsan purus vestibulum.
      </plus-tabs-panel>
