...
import '@htmlplus/components/dist/components/transition/transition';
import type { TransitionJSX as Type } from '@htmlplus/components/dist/components/transition/transition';
